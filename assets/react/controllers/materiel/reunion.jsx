...
export default function Réunion(props) {
  ...
  return (
    <>
      <main className="main">
        ...
        <Header title="Réunion" item="" props={props} loadingBtn={loadingBtn} Items={Items} Category={Category} setItem={setItem} />
          <Navbar />

          <section className="container">
            {allItems(props, "réunion")}
            <Footer />
          </section>
        </div>
      </main>
