...
export default function Réseau(props) {
    ...
    <>
      <main className="main">
        <div className="body">
          ...
          <Header title="Réseau" item="" props={props} loadingBtn={loadingBtn} Items={Items} Category={Category} setItem={setItem} />
          <Navbar />

          <section className="container">
            {allItems(props, "réseau")}
            <Footer />
          </section>
        </div>
      </main>
